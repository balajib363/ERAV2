...
class Model_S9(nn.Module):
    def __init__(self):
        ...
        # Input Block
        self.convblock1 = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=128, kernel_size=(3, 3),dilation=2, padding=0, bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(128),
            nn.Dropout(dropout_value)
        ) # output_size = 30
        ...
        # TRANSITION BLOCK 1
        self.convblock1x1a = nn.Sequential(
        ...
        # TRANSITION BLOCK 1
        self.convblock1x1b = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=64, kernel_size=(1, 1), padding=0, bias=False),
        ) # output_size = 28

        # CONVOLUTION BLOCK 2
        self.convblock3 = nn.Sequential(
            nn.Conv2d(in_channels=64, out_channels=256, kernel_size=3, stride=2, padding=0, groups=64, bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(256),
            nn.Dropout(dropout_value)
        ) # output_size = 13

        self.convblock1x1c = nn.Sequential(
        ...
        self.convblock1x1d = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=64, kernel_size=(1, 1), padding=0, bias=False),
        ) # output_size = 11
